...
load(file.path(interim_results_dir, paste0('fitted_total_biomass_', fit_scale_biomass, '.Rda')))
load(file.path(interim_results_dir, paste0('fitted_taxon_biomass_', fit_scale_biomass, '.Rda')))
